...
public class cam_manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(player.transform.position.x, player.transform.position.y + cam_player_gap, this.transform.position.z);
        setBound(bound);
    ...
    void Update()
    {
        ...
        /*if (map_manager.currentMap != "Title")
        {
    ...
    private void cameraMove()
    {
        if (player != null)
        {
            targetPos.Set(player.transform.position.x, player.transform.position.y + cam_player_gap, this.transform.position.z);
